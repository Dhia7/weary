...
export default function AboutPage() {
  ...
  return (
    <div className={pageShellClass}>
      ...
      <section className="border-b border-swisse-gold/10 dark:border-border">
        <div className={`${pageMainClass} !pb-16 !pt-28`}>
          <motion.div
          ...
          >
            <h1 className={pageTitleClass}>About Swisia</h1>
      ...
      <section className="bg-swisse-ink text-swisse-canvas dark:bg-foreground dark:text-background">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="text-center"
              >
                <div className="text-3xl md:text-4xl font-serif mb-2">{stat.number}</div>
                <div className="text-swisse-canvas/70 dark:text-background/70 text-[10px] font-bold uppercase tracking-widest">
                  {stat.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className={pageMainClass}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className={`${sectionTitleClass} mb-6`}>Our Story</h2>
          ...
          <motion.div
            ...
            className={`${cardClass} h-96 flex items-center justify-center bg-swisse-mist/50 dark:bg-muted/30`}
          >
            <div className={`text-center ${bodyTextClass}`}>
      ...
      <section className="border-y border-swisse-gold/10 dark:border-border bg-white/60 dark:bg-card/50">
        <div className={`${pageMainClass} !py-16`}>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          ...
          >
            <h2 className={`${sectionTitleClass} mb-4`}>Our Values</h2>
            <p className={`${pageSubtitleClass} mb-0`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="text-center"
              >
                <div className="border border-swisse-gold/20 dark:border-border w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <value.icon className="w-8 h-8 text-swisse-gold" />
                </div>
                <h3 className="text-xl font-serif text-swisse-ink dark:text-foreground mb-3">
                  {value.title}
                </h3>
      ...
      <section className={pageMainClass}>
        <motion.div
          ...
          className="text-center"
        >
          <h2 className={`${sectionTitleClass} mb-6`}>Our Mission</h2>
          <p className={`${pageSubtitleClass} max-w-4xl mx-auto mb-8`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="text-center">
              <CheckCircle className="w-12 h-12 text-swisse-gold mx-auto mb-4" />
